...
<body>
    ...
    <div class="humberger__menu__wrapper">
        <div class="humberger__menu__logo">
            <a href="#"><img src="{{asset('img/tari.jpg')}}" alt=""></a>
        </div>
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="header__logo">
                        <a href="./index.html"><img src="{{asset('template/img/art/tari.jpg')}}" alt=""></a>
                    </div>
                </div>
                <div class="col-lg-6">
